...
map('n', 'bacc', ':!clang -g -O3 -fuse-ld=mold *.c -o %:r.out<CR>', {noremap = true, silent = true}) --Builds c code with clang (all files)
map('n', 'bcpp', ':!clang++ -g -O3 -fuse-ld=mold % -o %:r.out<CR>', {noremap = true, silent = true}) --Builds c++ code with clang++
map('n', 'bacpp', ':!clang++ -g -O3 -fuse-ld=mold *.cpp -o %:r.out<CR>', {noremap = true, silent = true}) --Builds c++ code with clang++ (all files)
...
map('n', 'racc', ':!clang -g -O3 -fuse-ld=mold *.c -o %:r.out; ./%:r.out<CR>', {noremap = true, silent = true}) --Builds and runs c code with clang (all files)
map('n', 'rcpp', ':!clang++ -g -O3 -fuse-ld=mold % -o %:r.out; ./%:r.out<CR>', {noremap = true, silent = true}) --Builds and runs c++ code with clang++
map('n', 'racpp', ':!clang++ -g -O3 -fuse-ld=mold *.cpp -o %:r.out; ./%:r.out<CR>', {noremap = true, silent = true}) --Builds and runs c++ code with clang++ (all files)
